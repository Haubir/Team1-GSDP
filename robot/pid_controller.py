...
class LineFollower:
    ...
    def run(self):
        ...
        # sensors
        cs = ColorSensor();      assert cs.connected  # measures light intensity
        ...
        # motors
        lm = ev3.LargeMotor(OUTPUT_B);  assert lm.connected  # left motor
        rm = ev3.LargeMotor(OUTPUT_C);  assert rm.connected  # right motor
